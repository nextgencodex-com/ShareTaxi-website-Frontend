      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-blue-50 rounded-2xl p-8 mb-12">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-green-600 mb-2">{totalReviews}+</div>
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-purple-600 mb-2">{Math.round((averageRating / 5) * 100)}%</div>
              <div className="flex justify-center mb-2">
            ...
            <div className="space-y-2">
              {[5, 4, 3, 2, 1].map((stars, index) => (
                <div key={stars} className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-600 w-4">{ratingDistribution[index]}</span>
                </div>
              ))}
            </div>
          </div>
